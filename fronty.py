...
# Function to check common greetings
def check_greetings(user_input):
    greetings = ["hi", "hello", "hey", "yo"]
    for greeting in greetings:
        if fuzz.ratio(user_input.lower(), greeting.lower()) > 80:
            return True
    return False
...
def chat():
    ...
    if check_greetings(user_input):
        return jsonify({'response': "Hi! Welcome to EDUGENIUS!"})
